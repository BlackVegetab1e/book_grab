...
def run(
        weights= '/home/ros/haoyu/yolov5-master/best.pt',  # model path or triton URL
...
def parse_opt(path):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= '/home/ros/haoyu/yolov5-master/best.pt', help='model path or triton URL')
