...
int main(int argc, char** argv)
{
    ...
    moveJ_P_TargetPose.speed = 0.2;
        ...
        rm_msgs::MoveJ_P my_pose;
    my_pose.Pose.position.x = -0.317239;
    my_pose.Pose.position.y = 0.120903;
    my_pose.Pose.position.z = 0.355765 + 0.04;
    my_pose.Pose.orientation.x = -0.983404;
    my_pose.Pose.orientation.y = -0.178432;
    my_pose.Pose.orientation.z = 0.032271;
    my_pose.Pose.orientation.w = 0.006129;
    my_pose.speed = 0.1;
